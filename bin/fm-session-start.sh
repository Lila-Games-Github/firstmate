...
# data/captain.md, data/captain-shared.md, data/captain-questions.md,
...
#                       state/.afk daemon flag), a bounded unresolved
#                       learning-candidate summary when present, and a cheap
#                       per-task endpoint-liveness read: always runs;
#                       lock-refused mode passes the summary's non-mutating
#                       read-only option.
#   7. network checks - the result of the deferred network stage started back at
#                       step 1, harvested WITHOUT waiting for it.
#   8. context digest - data/projects.md, data/secondmates.md, data/captain.md,
#                       data/captain-shared.md, data/captain-questions.md,
...
data/captain-questions.md, and data/learnings.md.
...
print_file_or_absent "$DATA/captain-questions.md" "data/captain-questions.md"
