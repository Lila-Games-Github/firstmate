...
- Changes to the learning-candidate lifecycle keep exact record and command mechanics in `bin/fm-learning-candidate.sh`, semantic intake and routing in the narrowly triggered internal skill, contribution mechanics here, stable architecture in `docs/architecture.md`, operator layout in `docs/configuration.md`, and active cross-surface evidence in `docs/verification/learning-candidates.md`.
