...
Its acquisition and dead-owner recovery run through a transactional shared gate, so concurrent reapers cannot unlink a replacement generation and short owner-record writes cannot publish an unreadable lock.
