...
Durable route mutations share one cross-process lock, preserve a concurrent retirement deactivation, and re-read every matching route as inactive before post-action cleanup can be complete.
