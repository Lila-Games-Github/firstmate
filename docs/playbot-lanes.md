...
A populated submodule that cannot be inspected blocks retirement, as does a persisted submodule stash, detached head, or commit not represented by a remote-tracking ref.
