...
| `fm-playbot-lanes.mjs`   | Ensure, verify, serve, and invoke Playbot chat lanes from a terminal or a Playbot controller chat, with routed Stop-hook wakes for chat callers |
