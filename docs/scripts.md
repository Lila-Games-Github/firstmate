...
| `fm-playbot-lanes.mjs`   | Ensure, verify, serve, and invoke Playbot chat lanes and guarded workspace retirement from a terminal or a Playbot controller chat, with routed Stop-hook wakes for chat callers |
