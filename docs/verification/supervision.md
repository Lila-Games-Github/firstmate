...
The exact focused regression command `bin/fm-test-run.sh tests/fm-playbot-lanes.test.sh` passed with Node v26.7.0 and ended `FM_TEST_SUMMARY total=1 failed=0 skipped_gate=0` after 262,911 ms.
