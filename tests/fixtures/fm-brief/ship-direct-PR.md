...
1. First action: create your branch: `git checkout -b fm/fixture-direct-PR`

# Rules
1. Never push to the default branch (push only your `fm/fixture-direct-PR` branch). Never merge a PR.
...
4. Report status by appending one line:
   `echo "{state}: {one short line}" >> '/FM_HOME/state/fixture-direct-PR.status'`
