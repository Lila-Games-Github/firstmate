...
1. First action: create your branch: `git checkout -b fm/fixture-no-mistakes`
...
4. Report status by appending one line:
   `echo "{state}: {one short line}" >> '/FM_HOME/state/fixture-no-mistakes.status'`
