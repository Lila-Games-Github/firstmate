...
- **Durable learning candidates** - meaningful escaped defects, corrections, and workflow gaps survive task cleanup for later bounded curation, while routine successful work pays no audit cost and destination improvements still use their normal delivery authority.
...
- [docs/verification/learning-candidates.md](docs/verification/learning-candidates.md) - active maintainer verification for durable capture, curation, cleanup survival, and bounded startup visibility.
