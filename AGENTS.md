...
If a task is dispatched into a Playbot lane, scaffold with `--lane` and its branch options rather than countermanding the generated brief on dispatch; a lane brief needs no dispatch-time override.
